...
async function testInitialize() {
  ...
  const ix = createInstruction('initialize', [
...
async function testUpdateFee(configPda) {
  ...
  const ix = createInstruction('update_fee_config', [
    { pubkey: new web3.PublicKey(configPda), isSigner: false, isWritable: true },
...
async function testPause(configPda, paused) {
  ...
  const ix = createInstruction('set_paused', [
    { pubkey: new web3.PublicKey(configPda), isSigner: false, isWritable: true },
    { pubkey: wallet.publicKey, isSigner: true, isWritable: false }
  ], [pausedBuf]);
