...
async function example3() {
  ...
  console.log('✓ Blacklist status:', isBlacklisted ? 'BLACKLISTED' : 'NOT BLACKLISTED');
  ...
  console.log('  Standard (1000 tokens): fee =', feeStandard.fee.toNumber() / 10**6, 'tokens');
  ...
  console.log('  Whitelisted (1000 tokens): fee =', feeWhitelisted.fee.toNumber(), '(zero)');
