...
async function example2() {
  ...
  const remainingQuota = await roleManager.getRemainingQuota(mint, minter.publicKey);
  ...
  const newRemaining = await roleManager.getRemainingQuota(mint, minter.publicKey);
